...
# def tabla_multiplicar(numero:int,rango:int):
#     lista_tabla_multiplicar = []
#     for i in range(1,rango + 1):
#         lista_tabla_multiplicar.append(numero * i)
#     return lista_tabla_multiplicar

# print(tabla_multiplicar(2,12))
...
# def suma_pares(lista_numeros:list):
